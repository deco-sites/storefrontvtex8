...
function BannerItem(
  ...
  return (
    ...
    >
      ...
      {action && (
        <div class=" absolute top-0 md:bottom-0 bottom-1/2 left-0 right-0 sm:right-auto max-w-[407px] flex flex-col justify-end  px-8 py-12">
          <span class="text-2xl font-light text-base-500">
            {action.title}
          </span>
          <span class="font-normal text-4xl text-base-500">
            {action.subTitle}
          </span>
          <Button
